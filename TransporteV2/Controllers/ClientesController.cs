...
namespace TransporteV2.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(TAIProContext context)
        {
            _context = context;
        }
        ...
        {
            var tAIProContext = _context.Clientes.Include(c => c.IdCondicionIvaNavigation).Include(c => c.IdProvinciaNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TAIProContext.Clientes'  is null.");
            }
            var cliente = await _context.Clientes.FindAsync(id);
            if (cliente != null)
            {
