...
namespace TransporteV2.Controllers
{
    public class ComprasController : Controller
    {
        ...
        public ComprasController(TAIProContext context)
        {
            _context = context;
        }
        ...
        {
            var tAIProContext = _context.Compras.Include(c => c.IdFormaPagoNavigation);
        ...
        {
            ViewData["IdFormaPago"] = new SelectList(_context.FormasPagos, "IdFormaPago", "IdFormaPago");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCompra,Cantidad,Detalle,Precio,IdFormaPago,FechaCompra")] Compra compra)
        {
            ...
            ViewData["IdFormaPago"] = new SelectList(_context.FormasPagos, "IdFormaPago", "IdFormaPago", compra.IdFormaPago);
            return View(compra);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TAIProContext.Compras'  is null.");
            }
            var compra = await _context.Compras.FindAsync(id);
            if (compra != null)
            {
